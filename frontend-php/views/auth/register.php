<section class="row g-4 align-items-stretch py-4">
    <div class="col-lg-5">
        <div class="hero-shell p-4 p-lg-5 h-100">
            ...
            <h1 class="display-6 fw-bold mb-3">Crie um usuário vinculado à empresa correta.</h1>
            <p class="lead text-white-50 mb-4">
                O cadastro usa a chave da empresa para associar o usuário com segurança.
            </p>
            <ul class="list-unstyled mb-0 text-white-50">
                <li class="mb-2">Nome e e-mail do usuário</li>
                <li class="mb-2">Senha protegida</li>
                <li>Validação feita pelo sistema</li>
            </ul>
        </div>
    </div>
    <div class="col-lg-7">
        <div class="panel-card p-4 p-lg-5 h-100">
            ...
            <p class="text-secondary mb-4">Preencha os dados abaixo e use a chave da empresa responsável por esse usuário.</p>
            ...
            <form method="post" action="/cadastro" class="row g-3">
                ...
                <div class="col-12">
                    <label class="form-label" for="company_api_key">Chave da empresa</label>
